              ...
              <section>
                ...
                <table class="custom-table" id="dashboard-custom-table">
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" name="realname"
                               value="@if(isset($realname)){{ $realname }}@endif"
                               placeholder="This will be shown only to admin" type="text"></td>
                  </tr>
                  <tr>
                    <td>Nickname</td>
                    <td><input class="form-control" name="nickname"
                               value="@if(isset($nickname)){{ $nickname }}@endif" type="text"></td>
                  </tr>
                  <tr>
                    <td>School</td>
                    <td><input class="form-control" name="school"
                               value="@if(isset($school)){{ $school }}@endif" type="text"></td>
                  </tr>
                  <tr>
                    <td>Student ID</td>

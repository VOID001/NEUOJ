    ...
    <ul class="nav nav-stacked navigation" id="dashboard-subnav">
        {{-- @if(session('uid') && session('uid') <=2) --}}
            <ul class="dashboard-sidenav-mainmenu">
                ...
                <li id="dashboard_profile"><a href="/dashboard/profile"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Profile</a></li>
                @if($roleCheck->is("admin"))
                <li><a href="#"><span class="glyphicon glyphicon-align-justify" aria-hidden="true"></span>Management<span class="glyphicon glyphicon-chevron-down" style="float:right"></span></a>
                    <ul class="submenu">
                    ...
                    <li id="dashboard_executable"><a href="#"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span>Executables</a></li>
                    <li><a href="#"><span class="glyphicon glyphicon-font" aria-hidden="true"></span>Language</a></li>
                    <li id="dashboard_system"><a href="/dashboard/system"><span class="glyphicon glyphicon-link" aria-hidden="true"></span>SystemInfo</a></li>

                    <li><a id="dashboard_users" href="/dashboard/users"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Users</a></li>
                @endif
                <li id="dashboard_settings"><a href="/dashboard/settings"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>Settings</a></li>
            </ul>
    </ul>
</div>
<script>

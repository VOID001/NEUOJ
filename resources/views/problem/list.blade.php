            ...
            @if($problems != NULL)
                @foreach($problems as $problem)
                        <tr class="table_row">
                            ...
                            <td class="text-center table_row_td" onclick="javascript:window.location.href='/status/p/1?result=Accepted&pid={{ $problem->problem_id }}'">{{ $problem->ac_count. "/" . $problem->submission_count }}</td>
